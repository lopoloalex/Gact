...
<section class="resume-section p-3 p-lg-5  d-column" id="about">
   ...
   <form class="form-horizontal" role="form" action="EditarRootAsignaturaServlet">
       ...
       <div class="col-lg-10">
      	 <label  class="col-lg-2 control-label">Departamento</label>
      	 	<select class="form-control" name="Departamento">
            	<c:forEach items="${departamentos_lista}" var="departamento">
      ...
      <div class="form-group">
	   ...
	   <button class ="btn btn-info pull-right" type="submit"> Guardar							
      	...
      	<a href="RootAdministrar.jsp" class="btn btn-active">Volver</a>
</section>
</div>
